...
class Antique:
    def __init__(self):
        self._dataset = ir_datasets.load("antique/test/non-offensive")
        self._csv_lotte_dataset_file_path = 'storege/saved_en_dataset.csv'
        self._csv_loote_query_file_path = 'storege/saved_en_query.csv'
        self._csv_loote_quel_file_path = 'storege/saved_en_quel.csv'
